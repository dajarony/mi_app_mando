...
// in mi_app_expriment2/test/providers/tv_provider_test.dart.
...
import 'package:mi_app_expriment2/providers/settings_provider.dart' as _i4;
...
class MockSettingsProvider extends _i1.Mock implements _i4.SettingsProvider {
  ...
  @override
  String get philipsTvIp => (super.noSuchMethod(
        Invocation.getter(#philipsTvIp),
  ...
  @override
  String get subnet => (super.noSuchMethod(
        Invocation.getter(#subnet),
        returnValue: _i5.dummyValue<String>(
          this,
          Invocation.getter(#subnet),
        ),
  ...
  @override
  int get scanIpStart => (super.noSuchMethod(
        Invocation.getter(#scanIpStart),
        returnValue: 0,
      ) as int);

  @override
  int get scanIpEnd => (super.noSuchMethod(
        Invocation.getter(#scanIpEnd),
        returnValue: 0,
      ) as int);
  ...
  @override
  _i6.Future<bool> savePhilipsTvIp(String? ip) => (super.noSuchMethod(
        Invocation.method(
          #savePhilipsTvIp,
          [ip],
        ),
  ...
  @override
  _i6.Future<bool> saveNetworkScanSettings({
